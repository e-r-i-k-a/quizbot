...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/Root.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
var Confetti = function (_Component) {
  ...
  _createClass(Confetti, [{
    ...
    value: function render() {
      return _react2.default.createElement('canvas', { ref: this.canvas });
    }
  }]);
...
var spanSplit = function spanSplit(str) {
  var midpoint = Math.floor((str.length - 1) / 2);

  return str.split('').map(function (letter, i) {
    return _react2.default.createElement(
      'span',
      { className: 'end-letter', key: i,
        style: { '--delay': i <= midpoint ? i : str.length - 1 - i } },
      letter
    );
  });
};
...
var Footer = function Footer(props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'a',
        { href: 'https://twitter.com/erisammy', target: '_blank' },
        '@twitter'
      )
    ),
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'a',
        { href: 'https://github.com/e-r-i-k-a/quizbot', target: '_blank' },
        '@github'
      )
    )
  );
...
var _questions = __webpack_require__(/*! ../../questions */ "./questions.js");
  ...
  _createClass(Main, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          _props$quiz = _props.quiz,
          currentPage = _props$quiz.currentPage,
          lastPage = _props$quiz.lastPage,
          yes = _props$quiz.yes;
      ...
      if (currentPage === 0) {
        ...
        return _react2.default.createElement(
          'main',
          null,
          _react2.default.createElement(_Start2.default, { increment: increment })
        );
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_End2.default, { yes: yes, total: _questions.questions.length })
        );
      } else {
        var questionText = _questions.questions[currentPage - 1].q;
        return _react2.default.createElement(
          'main',
          null,
          _react2.default.createElement(_Header2.default, null),
          _react2.default.createElement(_Question2.default, { questionText: questionText, increment: increment })
        );
      }
    }
  }]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    increment: function increment(resp) {
      return dispatch({ type: 'INCREMENT_QUESTION', payload: resp });
    },
    decrement: function decrement() {
      return dispatch({ type: 'DECREMENT_QUESTION' });
    }
  };
};
...
var INCREMENT_QUESTION = exports.INCREMENT_QUESTION = 'INCREMENT_QUESTION';
var DECREMENT_QUESTION = exports.DECREMENT_QUESTION = 'DECREMENT_QUESTION';

/**
 * ACTION CREATORS
 */

var incrementQuestion = exports.incrementQuestion = function incrementQuestion(resp) {
  return {
...
var decrementQuestion = exports.decrementQuestion = function decrementQuestion() {
  return {
...
var _reducer = __webpack_require__(/*! ./reducer.js */ "./app/store/reducer.js");
...
var appReducer = (0, _redux.combineReducers)({ quiz: _reducer2.default });
...
var _actions = __webpack_require__(/*! ./actions */ "./app/store/actions.js");

var _questions = __webpack_require__(/*! ../../questions */ "./questions.js");

var initialState = {
  currentPage: 0,
  lastPage: _questions.questions.length + 1,
  yes: 0
};
...
exports.default = function () {
  ...
  switch (action.type) {
    case _actions.INCREMENT_QUESTION:
      action.payload === 'yes' ? newState.yes++ : null;
      newState.currentPage++;
      return newState;
    case _actions.DECREMENT_QUESTION:
...
const questions = [
	{
		q: 'Can you withstand long periods of time without water?'
	},
	{
		q: 'Do you provide food (milk and meat) or textiles (fiber from your hair)?'
	},
	{
		q: 'Do you have fatty deposits (or "humps") on your body?'
	},
	{
		q: 'Do you wear a thick coat that insulates you from intense heat?'
	},
	{
		q: 'Do you have a third, clear eyelid or two rows of long lashes to protect your eyes from blowing sand?'
	},
	{
		q: 'Are you a means of transport for passengers or cargo?'
	},
	{
		q: 'Do you make a variety of moans, groans, and deep, throaty bellows?'
	}
]
